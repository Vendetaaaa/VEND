...
fn program_level_analysis_reports_conflicts() {
    let a1 = AliasDecl { name: "a".into(), width: RegisterWidth::Reg64, physical: PhysicalRegister::RAX };
    let a2 = AliasDecl { name: "b".into(), width: RegisterWidth::Reg32, physical: PhysicalRegister::EAX };
    ...
    assert!(diags[0].0.contains("In function 'main'"));
}
